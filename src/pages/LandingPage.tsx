...
const PLANS = [
  {
    ...
    features: ['1 automation rule', '200 DMs / month', 'Basic analytics', 'Email support'],
    cta: 'Start Free',
    ctaTo: '/register',
    popular: false,
  },
  {
    ...
    features: ['5 automation rules', '1,000 DMs / month', 'Full analytics suite', 'Priority support', 'Custom templates', 'Performance tracking'],
    cta: 'Start Starter',
    ctaTo: '/register',
    popular: true,
  },
  {
    ...
    features: ['Unlimited rules', '5,000 DMs / month', 'Advanced analytics', '24/7 priority support', 'Multi-account management', 'Advanced API access', 'Dedicated account manager'],
    cta: 'Start Pro',
    ctaTo: '/register',
    popular: false,
  },
